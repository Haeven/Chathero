      ...
      <div className="py-16 sm:py-24">
        <div className="prose mx-auto max-w-3xl">
          ...
          <p>
            ...
            through the Account registration process, the User or the Guest
            declares that (i) he/she has read, understood and accepts the
            provisions of the Terms and Privacy Policy, (ii) his/her age and
            legal capacity enables to conclude an agreement with the Company,
            (iii) he/she has the right to act on behalf of the entity which
            he/she represents and his/her declarations are effective. If the
          ...
          <h5>2. Definitions</h5>
          <p>
            Unless otherwise indicated, the following capitalizes terms have the
            following meaning:
          </p>
          <p>
            <b>Account</b> – means individualized panel serving the User to
            exploit the Service and/or the Website.
          </p>
          <p>
            <b>Agreement</b> – means a subscription agreement that may be
            concluded between User and the Company, that specifies the scope and
          ...
          <p>
            ...
            other, which the Guest, or the User publishes, presents or sends on
            the Website or with the use of Service.
          </p>
          <p>
            <b>Device</b> – means devices such as a computer, telephone,
            smartphone, tablet or other electronic equipment which allows
            browsing web pages.
          </p>
          <p>
            <b>Guest</b> – means an entity browsing the Website.
          </p>
          <p>
            <b>Intellectual Property</b> – means any designations, inventions,
            utility models, industrial designs, works and other externalized
            expressions of creative activity that are the subject of exclusive
            rights of the Company.
          </p>
          <p>
            <b>License</b> – means a non-exclusive right to personal use of the
            API and/or the Widget.
          </p>
          <p>
            <b>Link</b> – means hyperlink referring to the Other Website.
          </p>
          <p>
            <b>Mobile Device</b> – means a portable device such as a telephone,
            smartphone, tablet or other electronic equipment which operates the
            Website and/or the Service.
          </p>
          <p>
            <b>Notification</b> – means message sent to the User as part of the
            Service.
          </p>
          <p>
            <b>Other Websites</b> – means websites other than the Website.
          </p>
          <p>
            <b>Password</b> – means the User’s anonymized verification tool
            which enables the access to the Account and is the sequence of signs
            possibly to entry by using the keyboard of the computer or Mobile
          ...
          <p>
            <b>Service</b> – means together the Website, Widget and/or the API
            (depending on the scope dedicated to a given User pursuant to the
            Agreement).
          </p>
          <p>
          ...
          <p>
            Above mentioned definitions retain their meaning regardless of
            whether they are expressed in the singular or the plural.
          </p>
          <h5>3. General Rules</h5>
          <p>
            Using the Service means full acceptance of the Terms. The Terms
            applies to relations between the Company and the Guest or the User
            only. If the Service and/or the Website introduces the possibility
            of providing services by other entities, they will be provided on
            the basis of regulations shared by these entities and only these
            entities will be responsible for the execution of the services,
            except the content of the Terms clearly and unambiguously indicates
            otherwise. Each entity using the Service and/or the Website is
            obliged to use it in accordance with its destiny resulting from the
            Terms. Using the Website is permissible provided that the Device
            meets jointly the following minimum technical requirements:
          </p>
          <ul>
            <li>has access to the Internet,</li>
            <li>
              allows the start-up of the one from following internet browsers:
              (i) Google Chrome, (ii) Opera, (iii) Firefox, (iv) Safari, (v)
              Microsoft Edge,
            </li>
            <li>
              the internet browser version used cannot be older than one year,
            </li>
            <li>has JavaScript enabled.</li>
          </ul>
          <p>
          ...
          <ul>
            <li>has access to the Internet,</li>
            <li>has software that enables sending HTTP requests.</li>
          </ul>
          <p>
            Using the Widget is possible if the following minimum technical
            requirements are met:
          </p>
          <ul>
            <li>has access to the Internet,</li>
          ...
          <p>
            It is recommended to install anti-virus software on the Device or on
            the Mobile Device.
          </p>
          <h5>4. Account</h5>
          <p>
            Account set-up is possible through the Website. Account set-up
            requires logging in using Facebook account, Google account or
            registering by providing other personal email and Password. When you
            create an Account you should provide us with accurate, complete, and
            current information at all times. Inaccurate, incomplete, or
            obsolete information may result in the immediate termination of your
            account on the Website and Service. You are responsible for
            maintaining the confidentiality of your Account and Password,
            including but not limited to the restriction of access to your
            Device or Mobile Device and/or Account. You agree to accept
            ...
            our Website and Service or a third-party service. You must notify us
          ...
          <p>
            By creating an Account, you can agree to subscribe to newsletters,
          ...
          <p>
            ...
            “Promotion(s)”) made available through Service or Website may be
            governed by rules that are separate from these Terms (in particular
            set out in the Agreement, if concluded). If you participate in any
            ...
            Terms, Promotion rules will apply.
          </p>
          <h5>7. Subscriptions</h5>
          <p>
            ...
            plan you select when purchasing a Subscription. At the end of each
            Billing Cycle, your Subscription will automatically renew under the
            ...
            complete billing information including (i) full name, (ii) email
          ...
          <p>
            ...
            The Company will provide you with a reasonable prior notice of any
          ...
          <p>
            ...
            videos, or other material (“Content”). You are responsible, in
            particular to your customers, for Content that you post on or
            through Service including its legality, reliability, and
            appropriateness. By posting Content on or through Service or
            Website, You represent and warrant that: (i) Content is yours (you
            own it) and/or you have the right to use it and the right to grant
            us the rights and license as provided in these Terms, and (ii) that
            the posting of your Content on or through Service does not violate
            ...
            terminate the Account of any User found to be infringing on a
            copyright. You retain any and all of your rights to any Content you
            submit, post or display on or through Service or Website and you are
          ...
          <ul>
            <li>
              ...
              engage in real time activities through Service or Website,
            </li>
            <li>
              use any robot, spider, or other automatic device, process, or
              means to access Service or Website for any purpose, including
              monitoring or copying any of the material on Service or Website,
            </li>
            <li>
              use any manual process to monitor or copy any of the material on
              Service or Website or for any other unauthorized purpose without
              our prior written consent,
            </li>
            <li>
              use any device, software, or routine that interferes with the
              proper working of Service or Website,
            </li>
            <li>
            ...
            <li>
              ...
              disrupt any parts of Service or Website, the server on which
              Service or Website is stored, or any server, computer, or database
              connected to Service or Website,
            </li>
            <li>
              attack Service or Website via a denial-of-service attack or a
          ...
          <p>
            ...
            use of our Service and Website.
          </p>
          <p>
          ...
          <p>
            ...
            to track and monitor the use of our Service and Website. This data
            is shared with other Google services. Google may use the collected
            data to contextualise and personalise the ads of its own advertising
          ...
          <p>
            ...
            using your information for analytics purposes by opting-out. To
            opt-out of Mixpanel service, please visit this page:{" "}
          ...
          <p>
            ...
            exclusive property of the Company and its licensors. The Service and
            the Website are protected by copyright, trademark, and other laws of
            ...
            without the prior written consent of the Company. The Guest and the
            User by using the Service do not acquire any rights to the
            Intellectual Property. It is prohibited to use the Intellectual
            Property for purposes other than those resulting from the authorized
            personal use referred to in the Article 23 of the Act of February 4,
            1994 on Copyright and Related Rights. Upon purchase of a
            Subscription, the User receives the Licence to use the Service in
            accordance with the Subscription. The Licence is limited,
            non-transferable, revocable, non-exclusive and granted for a period
            consistent with the conditions of the Subscription. The User is not
            entitled to give a sublicense. The Licence is granted only in the
            following forms of exploitation:
          </p>
          <ul>
            <li>
            ...
            <li>using the Service to serve the customers of the User.</li>
          </ul>
          <p>
            The User shall not modify, reverse engineer, decompile, disassemble
            or attempt to derive source code from Service or the Website or any
            portion thereof. The User is not entitled to create and/or publish
            APIs or otherwise proxying access to the Service or the Website nor
            is allowed to use the Service or the Website in an automated manner
            (that is by machine or computer program).
          </p>
          <h5>14. Copyright Policy</h5>
          <p>
            We respect the intellectual property rights of others. It is our
            policy to respond to any claim that Content posted with the use of
          ...
          <p>
            ...
            Guests and Users in solving their problems related to functioning of
            the Service, as well as undertakes actions to improve the quality of
            the Service’s functioning and the provision of the Service based on
          ...
          <p>
            Our Service and/or Website may contain links to Other Websites that
            ...
            policies, or practices of any Other Websites. We do not warrant the
            offerings of any of these entities/individuals or Other Websites.
            ...
            OTHER WEBSITES. WE STRONGLY ADVISE YOU TO READ THE TERMS OF SERVICE
            AND PRIVACY POLICIES OF ANY OTHER WEBSITES THAT YOU VISIT.
          </p>
          ...
          <p>
            ...
            EXPRESSLY AGREE THAT YOUR USE OF THE SERVICES, THEIR CONTENT, AND
          ...
          <p>
            ...
            with the content of tips, articles or other publications on the
            Website or the Service, including the content provided by the AI
            computer. You acknowledge that the AI computer that provides the
            content in the Service and/or the Website is not the expert and may
            be mistaken and you cannot rely on its answers or advice. In
            particular it cannot replace any professional recommendation. The
            Company shall not be liable to the customers of the User for the use
            of the Service and the Content provided by the Service to the User’s
            customers.The Company shall not be liable for the consequences of
            installing or sending any malicious software, phishing or any other
            practices undertaken by other entities to the Service. The Company
            shall not be liable for any breaks in the operation of the Service.
            The Company shall not be liable for the consequences of phenomena,
            including in particular power outages,
            fires, atmospheric phenomena, wars, riots, strikes and other similar
            events that are not affected by the Company. EXCEPT AS PROHIBITED BY
            ...
            CLAIM FOR PERSONAL INJURY OR PROPERTY DAMAGE, ARISING FROM THESE
            TERMS AND ANY VIOLATION BY YOU OF ANY FEDERAL, STATE, OR LOCAL LAWS,
            ...
            LAW, IF THERE IS LIABILITY FOUND ON THE PART OF COMPANY, IT WILL BE
            LIMITED TO THE AMOUNT PAID FOR THE SERVICES, AND UNDER NO
          ...
          <h5>20. The Guest’s/User’s Liability</h5>
          <p>
            The Guest and/or User is fully liable for the consequences of
            authorised or unauthorised distribution of any content available on
            the Website or the Service. This applies in particular to the
            Intellectual Property. The liability includes, in particular,
            Company&apos;s release from any claims in this respect if such are
            against Company. The User is solely liable for any Content
            published, presented, sent or in any other way provided during the
            use of Service to the User’s customers.
          </p>
          <h5>21. Service breaks</h5>
          <p>
            The Company does not guarantee the permanent accessibility of the
            Service or the Website. The Company reserves the right to introduce
            a break in the operation of the Website or the Service or their
            certain functionalities. If there is an intention to implement a
            break, the Company will notify about it by posting relevant
            information or a massage on the Website or via the email provided
            when setting-up the Account at least 3 days before the date of
            planned break. In the event of unintended breaks in the operation of
            the Website or the Service or their certain functionalities, the
            Company will immediately notify about it by posting a relevant
            information or message on the Website or via the email provided when
            setting-up the Account. Acceptance of the Regulations means also
            giving an approval for the Services being not 100% reliable.
          </p>
          <h5>22. Personal Data Protection and Security</h5>
          <p>
            The Company processes personal data with due diligence and ensuring
            adequate technical and organizational security measures. Detailed
            information about the protection of personal data can be found in
            the Privacy Policy. The Company shall not be liable for the personal
            data protection of the User’s customers that use the Service. The
            Company shall not be liable for the contents and rules of personal
            data protection and privacy on the Other Websites, including those
            to which the Links refer. The Company shall not be liable for the
            damages caused by browsing the Other Websites or posting any
            personal data or other information on them. The Company recommends
            reading the rules of personal data protection and privacy on the
            Other Websites, including those to which the Links refer, before
            starting using them, in particular before publishing own personal
            data or other essential information on the Other Websites.
          </p>
          <h5>23. Termination</h5>
          <p>
            We may terminate or suspend your Account and ban access to Service
          ...
          <p>
            ...
            you are no longer authorized to use Service. In case of any
            discrepancies between these Terms and the Agreement (if concluded),
            the provisions of the Agreement shall be applicable. The
            aforementioned sentence refers also to the amendments of these Terms
            introduced in the Agreement.
          </p>
