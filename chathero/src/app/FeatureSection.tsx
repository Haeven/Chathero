...
const FeatureSection: React.FC<FeatureSectionProps> = ({}) => {
  return (
    <section className="relative mx-auto mb-7 flex max-w-[75rem] flex-col items-start gap-7 p-4 py-10 md:p-10">
      ...
      <div className="flex flex-col items-start justify-center gap-16">
        <div className="grid grid-cols-1 flex-wrap items-start justify-center gap-10 lg:grid-cols-3">
          <div className="group/card relative flex flex-col overflow-hidden rounded-md border bg-white transition-all duration-500 ease-in-out hover:shadow-md">
            <div className="relative bg-zinc-200 transition-all duration-500 ease-in-out">
              {/* <Image
            alt="Trustworthy, Accurate Answers"
            loading="lazy"
            width="6511"
            height="4631"
            decoding="async"
            ...
            src="
              /_next/image?url=%2F_next%2Fstatic%2Fmedia%2F1.3ee50ff9.png&amp;w=3840&amp;q=75
            "
          /> */}
            </div>
            <div className="z-10 flex flex-col items-start gap-1 bg-white p-5 lg:h-[12.5rem] xl:h-[10rem]">
              ...
              <p className="text-md font-normal text-zinc-700">
                With features like &quot;Revise answers&quot; and
                &quot;Confidence score&quot; you can be sure your chatbot is
          ...
          <div className="group/card relative flex flex-col overflow-hidden rounded-md border bg-white transition-all duration-500 ease-in-out hover:shadow-md">
            ...
            className="bottom-0 object-contain object-center px-4 pt-8"
            style={{color: 'transparent'}}
            src="/_next/image?url=%2F_next%2Fstatic%2Fmedia%2F2.3562e944.png&amp;w=3840&amp;q=75"
          /> */}
            </div>
            <div className="z-10 flex flex-col items-start gap-1 bg-white p-5 lg:h-[12.5rem] xl:h-[10rem]">
              <h5 className="text-xl font-medium">Lead Generation Engine</h5>
              <p className="text-md font-normal text-zinc-700">
          ...
          <div className="group/card relative flex flex-col overflow-hidden rounded-md border bg-white transition-all duration-500 ease-in-out hover:shadow-md">
            ...
            className="bottom-0 object-contain object-center px-4 pt-8"
            style={{color: 'transparent'}}
            src="/_next/image?url=%2F_next%2Fstatic%2Fmedia%2F3.79889f05.png&amp;w=3840&amp;q=75"
          /> */}
            </div>
            <div className="z-10 flex flex-col items-start gap-1 bg-white p-5 lg:h-[12.5rem] xl:h-[10rem]">
              <h5 className="text-xl font-medium">Advanced Analytics</h5>
              <p className="text-md font-normal text-zinc-700">
        ...
        <div className="h-[0.15rem] w-1/4 self-center bg-opacity-60 bg-faded-gradient"></div>
        <div className="flex w-full flex-row flex-wrap items-start justify-between gap-16">
          <div className="flex flex-col items-start gap-1 md:max-w-[14rem]">
            ...
            <h5 className="pt-1 text-lg font-medium">Multiple Data Sources</h5>
          ...
          <div className="flex flex-col items-start gap-1 md:max-w-[14rem]">
            ...
            <p className="text-sm font-normal text-zinc-700">
              Customize your chatbot’s look and feel to match your brand’s style
              and website design.
            </p>
          </div>
          <div className="flex flex-col items-start gap-1 md:max-w-[14rem]">
          ...
          <div className="flex flex-col items-start gap-1 md:max-w-[14rem]">
            ...
            <h5 className="pt-1 text-lg font-medium">Privacy &amp; Security</h5>
            <p className="text-sm font-normal text-zinc-700">
          ...
          <div className="flex flex-col items-start gap-1 md:max-w-[14rem]">
            ...
            <p className="text-sm font-normal text-zinc-700">
              Connect your chatbot to your favorite tools like Slack, WhatsApp
              Zapier, and more.
            </p>
          </div>
          <div className="flex flex-col items-start gap-1 md:max-w-[14rem]">
          ...
          <div className="flex flex-col items-start gap-1 md:max-w-[14rem]">
            ...
            <h5 className="pt-1 text-lg font-medium">80+ Languages</h5>
            <p className="text-sm font-normal text-zinc-700">
              Reach your customers in their native language even if your data is
